...
```bash
luarocks install --local https://raw.githubusercontent.com/jonathanpoelen/lua-xmlparser/master/xmlparser-2.0-5.rockspec

# Or in your local lua-xmlparser directory

luarocks make --local xmlparser-2.0-5.rockspec
```
